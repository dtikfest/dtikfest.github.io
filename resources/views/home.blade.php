                ...
                <ul class="faq-list">
                    ...
                    <li>
                        ...
                        <div id="faq4" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                Exhibitor DTIK Fest 2021 adalah mahasiswa Semester 4 Jurusan Teknik Informatika dan Komputer Politeknik Elektronika Negeri Surabaya.
                            </p>
                        </div>
                    </li>
                    ...
                    <li>
                        <div data-bs-toggle="collapse" class="collapsed question" href="#faq6">Kapan waktu pendaftaran dibuka?<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                    ...
                    <li>
                        ...
                        <div id="faq7" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                Akses halaman exhibition <a href="https://dtik-fest.com/"><b>DTIK FEST</b></a>. Lakukan registrasi untuk membuat akun Virtua Hive. Ikuti arahan selanjutnya dari panitia terkait.
                            </p>
                        </div>
                    </li>

                    <li>
                        <div data-bs-toggle="collapse" class="collapsed question" href="#faq8">Bagaimana cara mengikuti DTIK Fest 2021 melalui Virtua Hive?<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                        <div id="faq8" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                Login menggunakan akun yang telah diregistrasi sebelumnya pada halaman exhibition <a href="https://dtik-fest.com/"><b>DTIK FEST</b></a>.
                            </p>
                        </div>
                    </li>
                    ...
                    <li>
                        <div data-bs-toggle="collapse" class="collapsed question" href="#faq10">Apakah saat hari H, visitor langsung masuk ke Virtua Hive atau menunggu arahan dari panitia?<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                    ...
                    <li>
                        <div data-bs-toggle="collapse" class="collapsed question" href="#faq12">Saya memiliki pertanyaan yang belum terjawab mengenai DTIK Fest 2021<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                        <div id="faq12" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                Dapat langsung menghubungi CP tertera, atau kontak melalui email ke <b>dtikfest@pens.ac.id</b>
                            </p>
                        </div>
                    </li>
                </ul>
